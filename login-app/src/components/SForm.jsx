		...
		<div className="bg-white p-20 rounded-lg shadow-md">
			<section className="relative flex flex-wrap lg:h-screen lg:items-center bg-blue-200 rounded-md">
				...
				<div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2 ">
					<img
						alt=""
						src="https://images.unsplash.com/photo-1721227755831-a09cbf344db6?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
						className="absolute inset-0 h-full w-full object-cover rounded-r-md"
					/>
				</div>
			</section>
		</div>
